...
fn init_virtual_keys() -> HashMap<String, VIRTUAL_KEY> {
    map![
        ...
        "CANCEL" => VK_CANCEL, "BACKSPACE" => VK_BACK, "BACK" => VK_BACK, "TAB" => VK_TAB, "RETURN" => VK_RETURN, "ENTER" => VK_RETURN, "PAUSE" => VK_PAUSE, "CAPITAL" => VK_CAPITAL,
        "ESCAPE" => VK_ESCAPE, "ESC" => VK_ESCAPE, "SPACE" => VK_SPACE,
        "PRIOR" => VK_PRIOR, "PAGE_UP" => VK_PRIOR, "PAGEUP" => VK_PRIOR, "NEXT" => VK_NEXT, "PAGE_DOWN" => VK_NEXT, "PAGEDOWN" => VK_NEXT, "HOME" => VK_HOME, "END" => VK_END,
